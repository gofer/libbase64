...
TEST(TestCase3_Alice_Cartelet_mod1, WithRefrence) {
...
TEST(TestCase3_Alice_Cartelet_mod1, WithPointer) {
  const std::string *src = new std::string("Alice Cartelet");
  const std::string *dst = new std::string("QWxpY2UgQ2FydGVsZXQ=");
